...
import { useDeleteAccount } from "@/app/services/auth";
      ...
      <div className="w-full">
        ...
        <div className="space-y-6 lg:space-y-0 lg:grid lg:grid-cols-2 lg:gap-6">
          ...
          <div className="lg:col-span-1 bg-white rounded-2xl p-6 md:p-7 shadow-sm">
            ...
            <p className="text-sm text-gray-500 mb-6">
              Permanently deleting your account will erase all your data.
            </p>
            <button
          ...
          <div className="bg-white rounded-2xl p-6 md:p-8 max-w-sm w-full shadow-xl">
            ...
            <div className="mb-5">
              ...
              <input
                ...
                className="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-[#BF010A]/20 focus:border-[#BF010A]"
              />
            </div>
            ...
            <div className="flex gap-3">
              <button
                ...
                disabled={isDeleting}
                className="flex-1 px-4 py-2.5 bg-gray-100 text-sm font-medium text-gray-700 hover:bg-gray-200 rounded-2xl transition-colors duration-200 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Cancel
              </button>
              <button
